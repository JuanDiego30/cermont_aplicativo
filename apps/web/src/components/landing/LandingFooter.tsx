...
const footerLinks = {
    ...
    recursos: [
        { label: 'Sistema de Gestión', href: '/login' },
        { label: 'SG-SST', href: '#' },
        { label: 'PESV', href: '#' },
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
                    ...
                    <div className="col-span-2 md:col-span-1">
                        <Link href="/" className="flex items-center gap-3 mb-6">
                            ...
                            <span className="text-xl font-bold text-white">CERMONT</span>
                        </Link>
                        <p className="text-sm leading-relaxed mb-6">
                            Soluciones integrales en construcción, electricidad, refrigeración,
                            montajes y suministros con más de 15 años de experiencia.
                        </p>
                        {/* Social Links */}
