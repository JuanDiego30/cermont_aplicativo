...
export class StatusBadgeComponent {
  ...
  get badgeClass(): string {
    ...
    if (this.type === 'orden' || statusLower.includes('planeacion') || statusLower.includes('ejecucion') || 
        statusLower.includes('pausada') || statusLower.includes('completada') || statusLower.includes('cancelada')) {
      return this.getOrdenBadgeClass(statusLower);
    }

    // Mapeo de estados de mantenimientos
    if (this.type === 'mantenimiento' || statusLower.includes('programado') || statusLower.includes('en_ejecucion') ||
        statusLower.includes('completado') || statusLower.includes('vencido')) {
