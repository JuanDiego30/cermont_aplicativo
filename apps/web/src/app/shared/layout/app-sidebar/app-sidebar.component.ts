...
export class AppSidebarComponent implements OnInit, OnDestroy {
  ...
  private readonly cdr = inject(ChangeDetectorRef);
    ...
    // Main nav items (limpio, solo rutas existentes)
    navItems: NavItem[] = [
      {
      ...
      {
        icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 2C12.4142 2 12.75 2.33579 12.75 2.75V3.75H15.25C16.4926 3.75 17.5 4.75736 17.5 6V9V19C17.5 20.2426 16.4926 21.25 15.25 21.25H8.75C7.50736 21.25 6.5 20.2426 6.5 19V9V6C6.5 4.75736 7.50736 3.75 8.75 3.75H11.25V2.75C11.25 2.33579 11.5858 2 12 2ZM8.75 5.25C8.33579 5.25 8 5.58579 8 6V8.25H16V6C16 5.58579 15.6642 5.25 15.25 5.25H12H8.75ZM16 9.75H8V19C8 19.4142 8.33579 19.75 8.75 19.75H15.25C15.6642 19.75 16 19.4142 16 19V9.75ZM10 12C10 11.5858 10.3358 11.25 10.75 11.25H13.25C13.6642 11.25 14 11.5858 14 12C14 12.4142 13.6642 12.75 13.25 12.75H10.75C10.3358 12.75 10 12.4142 10 12ZM10 15.25C10 14.8358 10.3358 14.5 10.75 14.5H13.25C13.6642 14.5 14 14.8358 14 15.25C14 15.6642 13.6642 16 13.25 16H10.75C10.3358 16 10 15.6642 10 15.25Z" fill="currentColor"></path></svg>`,
        name: "Mi Perfil",
        path: "/dashboard/perfil",
      },
      {
        icon: `<svg width=\"1em\" height=\"1em\" viewBox=\"0 0 24 24\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\"><path fill-rule=\"evenodd\" clip-rule=\"evenodd\" d=\"M3 6.75C3 5.23122 4.23122 4 5.75 4H18.25C19.7688 4 21 5.23122 21 6.75V17.25C21 18.7688 19.7688 20 18.25 20H5.75C4.23122 20 3 18.7688 3 17.25V6.75ZM5.75 5.5C5.05964 5.5 4.5 6.05964 4.5 6.75V17.25C4.5 17.9404 5.05964 18.5 5.75 18.5H18.25C18.9404 18.5 19.5 17.9404 19.5 17.25V6.75C19.5 6.05964 18.9404 5.5 18.25 5.5H5.75ZM6.75 7.5C6.33579 7.5 6 7.83579 6 8.25C6 8.66421 6.33579 9 6.75 9H12.75C13.1642 9 13.5 8.66421 13.5 8.25C13.5 7.83579 13.1642 7.5 12.75 7.5H6.75ZM6 12.25C6 11.8358 6.33579 11.5 6.75 11.5H17.25C17.6642 11.5 18 11.8358 18 12.25C18 12.6642 17.6642 13 17.25 13H6.75C6.33579 13 6 12.6642 6 12.25ZM6.75 15.5C6.33579 15.5 6 15.8358 6 16.25C6 16.6642 6.33579 17 6.75 17H13.5C13.9142 17 14.25 16.6642 14.25 16.25C14.25 15.8358 13.9142 15.5 13.5 15.5H6.75Z\" fill=\"currentColor\"></path></svg>`,
        name: "Administración",
        path: "/admin",
      },
    ];
