...
const NAV_ITEMS_CALENDAR_PROFILE: NavItem[] = [
  {
...
export class AppSidebarComponent implements OnInit, OnDestroy {
  ...
  // Main nav items - Navegación completa de CERMONT
  navItems: NavItem[] = [
    {
    ...
    ...NAV_ITEMS_CALENDAR_PROFILE,
    {
      name: "Reportes",
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2ZM12 4C16.4183 4 20 7.58172 20 12C20 16.4183 16.4183 20 12 20C7.58172 20 4 16.4183 4 12C4 7.58172 7.58172 4 12 4ZM12 6C8.68629 6 6 8.68629 6 12C6 15.3137 8.68629 18 12 18C15.3137 18 18 15.3137 18 12C18 8.68629 15.3137 6 12 6ZM12 8C13.6569 8 15 9.34315 15 11C15 12.6569 13.6569 14 12 14C10.3431 14 9 12.6569 9 11C9 9.34315 10.3431 8 12 8Z" fill="currentColor"></path></svg>`,
      subItems: [
