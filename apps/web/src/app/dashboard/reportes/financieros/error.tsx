/**
 * @file error.tsx
 * @description Error boundary para reportes financieros
 */
...
export default function ReportesFinancierosError({ error, reset }: ErrorProps) {
  useEffect(() => {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4">
      ...
      <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
        Error al cargar reportes financieros
      </h2>

      <p className="text-gray-500 dark:text-gray-400 text-center max-w-md mb-6">
        {error.message || 'Ocurrió un error inesperado al cargar los reportes financieros.'}
      </p>
