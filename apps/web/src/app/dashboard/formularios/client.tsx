/**
 * ARCHIVO: formularios/client.tsx
 * FUNCION: Dashboard de formularios con CRUD, estadísticas y vistas grid/lista
 * IMPLEMENTACION: Gestión plantillas, duplicar/eliminar, toggle vista, filtros
 * DEPENDENCIAS: React hooks, next/navigation, @/features/formularios, sonner
 * EXPORTS: FormulariosDashboard
 */
'use client';
