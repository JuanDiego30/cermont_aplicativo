/**
 * ARCHIVO: MonthlyOrdersChart.tsx
 * FUNCION: Gráfico de barras de órdenes mensuales (12 meses)
 * IMPLEMENTACION: Client Component con ApexCharts bar chart (dynamic import SSR:false)
 * DEPENDENCIAS: react-apexcharts, Dropdown, MoreDotIcon
 * EXPORTS: MonthlyOrdersChart (default)
 */
"use client";
