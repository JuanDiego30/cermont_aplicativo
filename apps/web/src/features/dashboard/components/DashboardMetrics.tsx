/**
 * ARCHIVO: DashboardMetrics.tsx
 * FUNCION: Grid de 4 tarjetas métricas del dashboard (Órdenes, Ejecución, Completadas, Pendientes)
 * IMPLEMENTACION: Client Component, MetricCard interno + DashboardMetrics grid 2x2
 * DEPENDENCIAS: Badge, iconos (OrdersIcon, PlayCircleIcon, CheckCircleIcon, ClockIcon, Arrow*)
 * EXPORTS: DashboardMetrics (named + default)
 */
"use client";
