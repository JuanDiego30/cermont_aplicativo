...
// DTOs existentes (migrados a ClassValidator)
import {
  CreatePlaneacionDto,
...
export class PlaneacionController {
  private readonly logger = new Logger(PlaneacionController.name);
  ...
  async createOrUpdate(
    ...
    try {
      const result = await this.createOrUpdatePlaneacion.execute(ordenId, dto);
