...
export class OrdenesKpiDto {
    ...
    @ApiProperty({ description: 'Tiempo promedio de resolución (horas)', example: 48 })
...
export class DashboardKpiDto {
    ...
    @ApiProperty({ description: 'Fecha de cálculo', example: '2024-12-24T18:12:00.000Z' })
    timestamp!: string;
}
...
export class KpiResponseDto<T> {
    ...
    @ApiProperty({ description: 'Fecha de generación', example: '2024-12-24T18:12:00.000Z' })
    timestamp!: string;
}
