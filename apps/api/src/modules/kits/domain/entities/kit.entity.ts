...
import { BusinessRuleViolationError, ValidationError } from '../../../../common/domain/exceptions';
import {
    KitCreatedEvent,
    KitUpdatedEvent,
    KitItemAddedEvent,
...
export class Kit {
    ...
    public static create(props: CreateKitProps, codigoSequence: number = 1): Kit {
        ...
        kit.addDomainEvent(new KitCreatedEvent({
            kitId: id.getValue(),
            nombre: props.nombre,
    ...
    public static fromPersistence(props: {
        ...
        const items = (props.items as unknown[]).map((item: unknown) => {
            ...
            return KitItem.fromPersistence({
                ...
                requiereCertificacion: (i['requiereCertificacion'] as boolean) || (i['certificacion'] as boolean) || false,
    ...
    public addItem(itemProps: CreateKitItemProps): void {
        ...
        this.addDomainEvent(new KitItemAddedEvent({
    ...
    public removeItem(itemId: string): void {
        ...
        this.addDomainEvent(new KitItemRemovedEvent({
            kitId: this._id.getValue(),
    ...
    public updateInfo(updates: {
        ...
        this.addDomainEvent(new KitUpdatedEvent({
            kitId: this._id.getValue(),
            nombre: this._nombre,
        }));
    }
