...
export class KitsController {
  ...
  @ApiResponse({ status: 200, description: 'Lista de kits', type: KitListResponseDto })
  ...
  @ApiResponse({ status: 200, description: 'Kit encontrado', type: KitResponseDto })
  ...
  @ApiResponse({ status: 200, description: 'Kit actualizado', type: KitResponseDto })
  @ApiParam({ name: 'id', description: 'ID del kit' })
  async update(
    @Param('id') id: string,
  ...
  @ApiResponse({ status: 201, description: 'Item agregado', type: KitResponseDto })
  @ApiParam({ name: 'id', description: 'ID del kit' })
  async addItem(
    @Param('id') id: string,
  ...
  @ApiResponse({ status: 200, description: 'Item eliminado', type: KitResponseDto })
  @ApiParam({ name: 'id', description: 'ID del kit' })
  ...
  @ApiResponse({ status: 200, description: 'Kit activado', type: KitResponseDto })
  @ApiParam({ name: 'id', description: 'ID del kit' })
  ...
  @ApiResponse({ status: 200, description: 'Kit desactivado', type: KitResponseDto })
  @ApiParam({ name: 'id', description: 'ID del kit' })
  ...
  async applyPredefinedToExecution(
    ...
    return this.kitsService.applyPredefinedKitToExecution(tipo, ejecucionId, 'system');
  }
