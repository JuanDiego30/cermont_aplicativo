...
export class CertificacionTecnico {
    ...
    get tecnicoId(): string { return this._tecnicoId; }
    get tipo(): TipoCertificacion { return this._tipo; }
    get entidadCertificadora(): string { return this._entidadCertificadora; }
    get numeroCertificado(): string { return this._numeroCertificado; }
    get fechaEmision(): Date { return this._fechaEmision; }
    get fechaVencimiento(): Date { return this._fechaVencimiento; }
    get archivoUrl(): string | undefined { return this._archivoUrl; }
