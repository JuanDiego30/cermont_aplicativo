...
export class Evidence {
    ...
    public static fromPersistence(props: Omit<EvidenceProps, 'capturedLocation'> & { capturedLocation?: Record<string, unknown> }): Evidence {
        return new Evidence({
            ...props,
            capturedLocation: props.capturedLocation ? GeoLocation.fromJson(props.capturedLocation) : undefined,
        });
    }
