 ...
 * Sync item type
 */
export type SyncItemType = 'EJECUCION' | 'CHECKLIST' | 'EVIDENCIA' | 'TAREA' | 'COSTO' | 'AST' | 'HES' | 'FIRMA';
...
export class SyncQueueItem {
    ...
    get tipo(): SyncItemType { return this._tipo; }
    get operacion(): SyncOperationType { return this._operacion; }
    get datos(): Record<string, unknown> { return { ...this._datos }; }
    get timestamp(): Date { return this._timestamp; }
    get deviceId(): DeviceId { return this._deviceId; }
    get userId(): string { return this._userId; }
    get ordenId(): string | undefined { return this._ordenId; }
    get ejecucionId(): string | undefined { return this._ejecucionId; }
    get status(): SyncStatus { return this._status; }
    get priority(): SyncPriority { return this._priority; }
    get retryCount(): number { return this._retryCount; }
    get lastRetryAt(): Date | undefined { return this._lastRetryAt; }
    get errorMessage(): string | undefined { return this._errorMessage; }
    get syncedAt(): Date | undefined { return this._syncedAt; }
