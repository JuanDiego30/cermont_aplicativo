 ...
 */
import { IsString, IsNotEmpty, IsOptional, IsBoolean, IsObject, IsArray, IsEnum } from 'class-validator';
...
export class CreateFormTemplateDto {
            ...
            sections: [
                {
                    ...
                    fields: [
                        { id: 'numero_linea', label: 'Número Línea', type: 'text', required: true },
                    ],
                },
            ],
        },
    ...
    @ApiPropertyOptional({ description: 'UI Schema opcional para estilos/layout' })
    @IsOptional()
    @IsObject()
