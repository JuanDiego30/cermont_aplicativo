...
export class WeatherController {
  ...
  @ApiOperation({
    ...
    description: 'Retorna datos meteorológicos actuales y pronóstico de 7 días para las coordenadas especificadas.',
  })
  @ApiQuery({
    name: 'lat',
  ...
  @ApiResponse({ status: 503, description: 'Servicio meteorológico no disponible' })
