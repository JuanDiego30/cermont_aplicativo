  ...
  async getWeatherAlerts(
    ...
    if (currentWeather.temperature > 35) {
      alerts.push({
        ...
        recommendation: 'Hidratarse frecuentemente. Tomar descansos en sombra. Evitar exposición prolongada.',
        timestamp: new Date().toISOString(),
      });
    }
    ...
    if (currentWeather.uvIndex && currentWeather.uvIndex > 8) {
      alerts.push({
        ...
        recommendation: 'Usar protector solar SPF50+. Usar ropa protectora y sombrero. Evitar exposición entre 10am-4pm.',
        timestamp: new Date().toISOString(),
      });
    }
    ...
    if (currentWeather.cloudCover > 80 || currentWeather.precipitation > 0) {
      alerts.push({
        ...
        description: currentWeather.precipitation > 0
