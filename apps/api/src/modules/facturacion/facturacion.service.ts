...
export class FacturacionService {
    ...
    private mapSESToResponse(ses: any, numeroOrden: string): SESResponseDto {
        const diasPendiente = ses.estado !== 'aprobada'
    ...
    private mapFacturaToResponse(factura: any): FacturaResponseDto {
        const diasPendiente = factura.estado !== 'pagada'
    ...
    private generarAlertas(sesPendientes: any[], facturasPendientes: any[]): Array<{
        tipo: string;
        mensaje: string;
        nivel: string;
        relacionadoId: string;
    }> {
        const alertas: Array<{ tipo: string; mensaje: string; nivel: string; relacionadoId: string }> = [];
