...
export class PaginationUtil {
     ...
     */
    static normalizeQuery(query: PaginationQuery): Required<Omit<PaginationQuery, 'sortBy' | 'sortOrder'>> & Pick<PaginationQuery, 'sortBy' | 'sortOrder'> {
...
export { PaginationQueryDto, PaginationWithSortDto, SearchPaginationDto } from '../dto/pagination.dto';
