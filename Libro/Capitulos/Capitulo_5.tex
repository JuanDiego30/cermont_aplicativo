...
% Versión académica sin datos cuantitativos no verificados
% =====================================================================
...
\small
\def\FaseRow#1#2#3#4{\parbox[t]{3.0cm}{\raggedright #1} & \parbox[t]{4.8cm}{\raggedright #2} & \parbox[t]{4.0cm}{\raggedright #3} & \parbox[t]{2.5cm}{\raggedright #4}\\\hline}
...
\scriptsize
\ClassicTableSetup
\begin{longtable}{|C{0.9cm}|L{3.2cm}|C{1.2cm}|L{5.2cm}|L{3.0cm}|}
...
\hline\ClassicTableHeader
\textbf{Doc.} & \textbf{Tema principal} & \textbf{Cap.} & \textbf{Evidencia resumida} & \textbf{Estado metodológico} \\
\hline
\endfirsthead
...
\hline
\endlastfoot
00 & Base transversal & 5, 6, 8 & Roles, autenticación, API, diseño y observabilidad. & Soporte de arquitectura.\\ \hline
01 & Dashboard y KPIs & 6, 7 & Panel de seguimiento gerencial y contratos de analítica. & Implementado como vista de seguimiento.\\ \hline
02 & Solicitudes & 1, 6, 7 & Entrada formal del servicio y creación de requerimientos. & Implementado.\\ \hline
03 & Visitas técnicas & 1, 6, 7 & Registro de levantamientos, mediciones y evidencias iniciales. & Implementado; captura dedicada pendiente.\\ \hline
04 & Propuestas & 1, 6, 7 & Oferta técnica y económica vinculada al flujo comercial. & Implementado.\\ \hline
05 & Órdenes & 1, 6, 7 & Entidad central que agrupa estados, reglas y trazabilidad. & Implementado.\\ \hline
06 & Planeación & 1, 6, 7 & Paquetes de recursos, kits, personal y documentos previos. & Implementado.\\ \hline
07 & Ejecución & 1, 6, 7 & Sesiones de campo, formularios, estados y sincronización parcial. & Implementado con alcance offline parcial.\\ \hline
08 & Evidencias & 1, 6, 7, 8 & Gestión visual y contratos de soportes asociados a órdenes. & Implementado; sincronización binaria completa pendiente.\\ \hline
09 & Informes técnicos & 1, 6, 7, 8 & Generación y consulta de informes derivados de la ejecución. & Implementado con evidencia técnica.\\ \hline
10 & Actas & 1, 6, 7 & Actas de entrega y soporte de aceptación del cliente. & Implementado.\\ \hline
11 & Cierre administrativo & 1, 6, 7 & Vista de seguimiento documental posterior a la ejecución. & Implementado como control interno.\\ \hline
12 & SES / Ariba & 1, 6, 7 & Registro y control de SES, referencias y soportes. & Implementado sin integración externa directa.\\ \hline
13 & Facturas & 1, 6, 7 & Seguimiento de facturas y estado de aprobación. & Implementado; captura dedicada pendiente.\\ \hline
14 & Pagos & 1, 6, 7 & Registro de pago y cierre financiero del servicio. & Implementado.\\ \hline
15 & Costos & 1, 6, 7 & Comparación entre propuesta, ejecución y cierre. & Implementado; métricas reales pendientes.\\ \hline
16 & Activos & 6, 7 & Asociación de intervenciones con equipos o sistemas atendidos. & Implementado.\\ \hline
17 & Mantenimiento & 6, 7 & Catálogos y kits para actividades repetibles. & Implementado.\\ \hline
18 & Documentos & 5, 6, 7 & Núcleo documental para soportes, plantillas y archivos. & Implementado.\\ \hline
19 & Recursos y kits & 1, 6, 7 & Disponibilidad de recursos para planeación y ejecución. & Implementado.\\ \hline
20 & Usuarios y RBAC & 6, 7, 8 & Administración de usuarios, permisos y roles. & Implementado.\\ \hline
21 & Estabilización & 5, 8 & Pruebas, compuertas y preparación para entrega. & Soporte de validación técnica.\\ \hline
\end{longtable}
\endgroup
...
\def\IndicatorRow#1#2#3{\parbox[t]{3.5cm}{\raggedright #1} & \parbox[t]{7.3cm}{\raggedright #2} & \parbox[t]{3.2cm}{\raggedright #3}\\\hline}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{|l|l|l|}
\hline\ClassicTableHeader
...
\def\GateRow#1#2#3{\parbox[t]{3.0cm}{\raggedright #1} & \parbox[t]{7.5cm}{\raggedright #2} & \parbox[t]{3.5cm}{\raggedright #3}\\\hline}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{|l|l|l|}
\hline\ClassicTableHeader
...
\def\MatrizRow#1#2#3#4#5{\parbox[t]{2.0cm}{\raggedright #1} & \parbox[t]{1.9cm}{\raggedright #2} & \parbox[t]{3.3cm}{\raggedright #3} & \parbox[t]{2.7cm}{\raggedright #4} & \parbox[t]{2.8cm}{\raggedright #5}\\\hline}
\begin{adjustbox}{max width=\textwidth}
...
\small
\def\CronoRow#1#2#3{\parbox[t]{5.3cm}{\raggedright #1} & \parbox[t]{4.7cm}{\raggedright #2} & \parbox[t]{3.2cm}{\raggedright #3}\\\hline}
\begin{tabular}{|l|l|l|}
\hline\ClassicTableHeader
...
\begin{longtable}{|p{1.6cm}|p{4.2cm}|p{5.1cm}|p{3.2cm}|}
