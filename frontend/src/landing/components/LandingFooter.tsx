		...
		<footer className="border-t border-hairline-dark bg-canvas-dark">
			<div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
				<div className="grid gap-10 lg:grid-cols-[1.4fr_0.8fr_1.2fr]">
					<div>
						<Logo href="/" className="gap-3" size="lg" hideWordmarkOnMobile={false} wordmarkClassName="text-on-dark" />
					...
					<div>
						...
						<address className="space-y-2.5 text-sm not-italic text-steel">
							...
							>
								<Mail className="size-3.5 text-green-600 dark:text-green-400" aria-hidden="true" />
								{CORPORATE_EMAIL}
							</a>
							<div className="flex items-start gap-2">
								<MapPin className="mt-0.5 size-3.5 shrink-0 text-green-600 dark:text-green-400" aria-hidden="true" />
								<div>
							...
							<div className="flex items-center gap-2">
								<PhoneCall className="size-3.5 text-green-600 dark:text-green-400" aria-hidden="true" />
						...
						<div className="mt-6">
							<Button asChild className="rounded-full px-5 bg-green-600 hover:bg-green-700 text-white">
