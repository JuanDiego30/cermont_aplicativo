...
const logger = createLogger("maintenance:error-boundary");
	...
	return (
		...
		>
			<header className="flex flex-col items-center gap-2">
				...
				<h2 id="maintenance-error-title" className="text-lg font-semibold text-slate-900">
					Error en mantenimientos
				</h2>

				<p className="max-w-sm text-sm text-slate-600">
					Ocurrió un error al cargar el módulo de mantenimientos.
				</p>
			...
			<footer className="flex gap-3">
				...
				<Link
					href="/dashboard"
					className="rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-700 transition-colors hover:bg-slate-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-400"
				>
					Ir al inicio
				</Link>
			</footer>
