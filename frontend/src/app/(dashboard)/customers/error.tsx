...
const logger = createLogger("customers:error-boundary");
...
export default function CustomersError({ error, reset }: ErrorProps) {
	...
	return (
		<section
			...
			role="alert"
			aria-live="assertive"
			aria-labelledby="customers-error-title"
		>
			<header className="flex flex-col items-center gap-2">
				...
				<h2 id="customers-error-title" className="text-lg font-semibold text-zinc-900">
					Error en clientes
				</h2>
			...
			<footer className="flex gap-3">
				...
				<Link
					href="/dashboard"
					className="rounded-lg border border-zinc-200 bg-background px-4 py-2 text-sm font-medium text-zinc-700 transition hover:bg-zinc-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400"
				>
					Ir al inicio
				</Link>
			</footer>
