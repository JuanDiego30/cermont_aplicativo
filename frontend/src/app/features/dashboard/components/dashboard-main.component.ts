...
import { DashboardMetricas, DashboardStats, OrdenReciente } from '../../../core/models/dashboard.model';
  ...
  template: `
    <div class="space-y-6">
      ...
      <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="p-6 bg-white border border-gray-200 rounded-xl dark:bg-gray-800 dark:border-gray-700">
          <div class="flex items-center gap-4">
            <div class="flex items-center justify-center w-12 h-12 rounded-xl bg-brand-100 dark:bg-brand-500/10">
            ...
            <div>
              ...
              <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ stats()?.totalOrdenes || 0 }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="p-6 bg-white border border-gray-200 rounded-xl dark:bg-gray-800 dark:border-gray-700">
          <div class="flex items-center gap-4">
            <div class="flex items-center justify-center w-12 h-12 rounded-xl bg-yellow-100 dark:bg-yellow-500/10">
            ...
            <div>
              ...
              <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ stats()?.ordenesPendientes || 0 }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="p-6 bg-white border border-gray-200 rounded-xl dark:bg-gray-800 dark:border-gray-700">
          <div class="flex items-center gap-4">
            <div class="flex items-center justify-center w-12 h-12 rounded-xl bg-blue-100 dark:bg-blue-500/10">
            ...
            <div>
              ...
              <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ stats()?.ordenesEnProceso || 0 }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="p-6 bg-white border border-gray-200 rounded-xl dark:bg-gray-800 dark:border-gray-700">
          <div class="flex items-center gap-4">
            <div class="flex items-center justify-center w-12 h-12 rounded-xl bg-green-100 dark:bg-green-500/10">
            ...
            <div>
              ...
              <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ stats()?.ordenesCompletadas || 0 }}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="grid gap-6 lg:grid-cols-2">
        <!-- Métricas -->
        <div class="p-6 bg-white border border-gray-200 rounded-xl dark:bg-gray-800 dark:border-gray-700">
          <h2 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Métricas de Rendimiento</h2>
          <div class="grid gap-4 sm:grid-cols-2">
            <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50">
              <p class="text-sm text-gray-500 dark:text-gray-400">Tiempo Promedio</p>
              <p class="text-xl font-bold text-gray-900 dark:text-white">{{ metricas()?.tiempoPromedioEjecucion || 0 }} min</p>
            </div>
            <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50">
              <p class="text-sm text-gray-500 dark:text-gray-400">Eficiencia</p>
              <p class="text-xl font-bold text-gray-900 dark:text-white">{{ metricas()?.eficiencia || 0 }}%</p>
            </div>
            <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50">
              <p class="text-sm text-gray-500 dark:text-gray-400">Costo Promedio</p>
              <p class="text-xl font-bold text-gray-900 dark:text-white">{{ metricas()?.costoPromedio | currency:'COP':'symbol':'1.0-0' }}</p>
            </div>
            <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50">
              <p class="text-sm text-gray-500 dark:text-gray-400">Órdenes/Mes</p>
              <p class="text-xl font-bold text-gray-900 dark:text-white">{{ metricas()?.ordenesCompletadasMes || 0 }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="p-6 bg-white border border-gray-200 rounded-xl dark:bg-gray-800 dark:border-gray-700">
          <div class="flex items-center justify-between mb-4">
            ...
            <a routerLink="/orders" class="text-sm text-brand-500 hover:text-brand-600">Ver todas →</a>
          </div>
