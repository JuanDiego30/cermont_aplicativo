    ...
    <div class="relative inline-block">
      ...
      <div class="relative group cursor-pointer" (click)="fileInput.click()">
        ...
        @if (currentAvatar()) {
          ...
          <div
            class="flex h-32 w-32 items-center justify-center rounded-full bg-gradient-to-br from-cermont-primary-400 to-cermont-primary-600 border-4 border-white dark:border-gray-800 shadow-lg transition-all duration-200 group-hover:brightness-90"
          >
        ...
        <div
          class="absolute inset-0 flex items-center justify-center rounded-full bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-200"
        >
        ...
        <!-- Edit badge -->
        <div
          class="absolute bottom-0 right-0 flex h-10 w-10 items-center justify-center rounded-full bg-cermont-primary-600 border-4 border-white dark:border-gray-800 shadow-lg group-hover:scale-110 transition-transform duration-200"
        >
      ...
      @if (error()) {
        <div class="absolute -bottom-16 left-1/2 -translate-x-1/2 w-64 text-center">
          <p
            class="text-sm text-error-600 dark:text-error-400 bg-white dark:bg-gray-900 rounded-lg px-4 py-2 shadow-lg"
          >
            {{ error() }}
          </p>
        </div>
