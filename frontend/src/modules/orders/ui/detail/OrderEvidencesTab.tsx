...
export function OrderEvidencesTab({ orderId }: OrderEvidencesTabProps) {
	...
	return (
		...
		>
			...
			{totalEvidences === 0 ? (
				<div className="flex flex-col items-center justify-center py-8 text-center">
					<Camera className="mb-4 size-10 text-zinc-300 dark:text-zinc-600" aria-hidden="true" />
					<h3 className="text-lg font-semibold text-zinc-900 dark:text-white">Sin evidencias</h3>
