...
export abstract class BaseService<T> {
  ...
  async findAll(
    ...
    try {
      ...
      this.logger.error(
        `Error finding all ${this.constructor.name}`,
        error as any,
      );
      throw error;
    }
  ...
  async findOne(id: string, include?: any): Promise<T> {
    ...
    try {
      ...
      this.logger.error(
        `Error finding ${this.constructor.name} by id`,
        error as any,
      );
      throw error;
    }
  ...
  async create(data: any, include?: any): Promise<T> {
    ...
    try {
      ...
      this.logger.error(
        `Error creating ${this.constructor.name}`,
        error as any,
      );
      throw error;
    }
  ...
  async update(id: string, data: any, include?: any): Promise<T> {
    ...
    try {
      ...
      this.logger.error(
        `Error updating ${this.constructor.name}`,
        error as any,
      );
      throw error;
    }
  ...
  async delete(id: string): Promise<T> {
    ...
    try {
      ...
      this.logger.error(
        `Error deleting ${this.constructor.name}`,
        error as any,
      );
      throw error;
    }
