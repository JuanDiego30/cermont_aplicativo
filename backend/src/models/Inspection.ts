...
// ✓ inspection_type: enum ['pulidora', 'arnes', 'electrico', 'extintor', 'vehiculo', 'generico']
...
export type InspectionType =
	| "pulidora" // Inspección de pulidoras/esmeriladoras
	| "arnes" // Inspección de arnés de seguridad
	| "electrico" // Inspección de equipos eléctricos
	| "extintor" // Inspección de extintores
	| "vehiculo" // Inspección de vehículos
	| "generico"; // Inspección genérica
...
const inspectionSchema = new Schema<IInspection>(
	{
		...
		inspection_type: {
			type: String,
			enum: ["pulidora", "arnes", "electrico", "extintor", "vehiculo", "generico"],
			required: true,
			index: true,
		},
		status: {
