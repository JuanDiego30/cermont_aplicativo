...
// ✓ actual_items: [{category, description, unit, quantity, unit_price, total, is_budgeted, notes}]
...
export interface ICostLineItem {
	...
	is_budgeted: boolean; // true = fue presupuestado, false = emergió en campo
	notes?: string;
}
...
const costLineItemSchema = new Schema<ICostLineItem>(
	{
		...
		is_budgeted: { type: Boolean, required: true, default: true },
