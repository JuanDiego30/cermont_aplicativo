...
describe('Monto Value Object', () => {
  describe('create', () => {
    ...
    it('debe lanzar error para valores muy grandes', () => {
      expect(() => Monto.create(1000000000)).toThrow('Monto excede límite máximo permitido');
    });
  });
...
describe('OrdenNumero Value Object', () => {
  describe('create', () => {
    ...
    it('debe lanzar error para formato inválido', () => {
      expect(() => OrdenNumero.create('INVALID')).toThrow('Formato inválido: debe ser ORD-XXXXXX');
    });

    it('debe lanzar error para string vacío', () => {
      expect(() => OrdenNumero.create('')).toThrow('OrdenNumero no puede ser vacío');
    });
  });
...
describe('OrdenEstado Value Object', () => {
  describe('create', () => {
    ...
    it('debe lanzar error para estado inválido', () => {
      expect(() => OrdenEstado.create('INVALIDO')).toThrow('Estado inválido: INVALIDO');
    });
  });
