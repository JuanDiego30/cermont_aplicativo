...
describe('GenerateReporteMantenimientoUseCase', () => {
  ...
  it('sirve desde cache cuando está habilitado y existe', async () => {
    const useCase = new GenerateReporteMantenimientoUseCase(prisma as any, pdfBuild);
    ...
    expect(result.filename).toMatch(/^reporte-mantenimiento-[A-Za-z0-9_]+-[a-f0-9]{16}\.pdf$/);
