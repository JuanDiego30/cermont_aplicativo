...
export class TipoCertificacion {
  ...
  static fromString(value: string): TipoCertificacion {
    if (Object.values(TipoCertificacionTecnico).includes(value as TipoCertificacionTecnico)) {
      return new TipoCertificacion(value);
    }
    if (Object.values(TipoCertificacionEquipo).includes(value as TipoCertificacionEquipo)) {
      return new TipoCertificacion(value);
    }
  ...
  isTecnico(): boolean {
    return Object.values(TipoCertificacionTecnico).includes(this.value as TipoCertificacionTecnico);
  }

  isEquipo(): boolean {
    return Object.values(TipoCertificacionEquipo).includes(this.value as TipoCertificacionEquipo);
  }
