...
export class CreateOrdenDto {
  ...
  @IsString()
  @MaxLength(200, {
    message: "El nombre del cliente no puede exceder 200 caracteres",
  })
  cliente!: string;
  ...
  @IsEnum(Prioridad, {
    message:
      "Prioridad inválida. Valores permitidos: baja, media, alta, urgente",
  })
  prioridad!: Prioridad;
  ...
  @IsDateString(
    {},
    { message: "Fecha de finalización debe estar en formato ISO 8601" },
  )
  ...
  @ApiPropertyOptional({
    description:
      "Indica si requiere Hoja de Especificaciones de Seguridad (HES)",
    example: true,
    default: false,
  })
  @IsOptional()
