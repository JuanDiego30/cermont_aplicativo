...
import { COSTO_REPOSITORY, ICostoRepository, RegistrarCostoDto, CostoResponse } from '../dto';
...
export class RegistrarCostoUseCase {
  ...
  async execute(dto: RegistrarCostoDto): Promise<{ message: string; data: CostoResponse }> {
