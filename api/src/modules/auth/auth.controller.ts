/**
 * Controlador de autenticación para Cermont que maneja login, registro, refresh de tokens,
 * logout, verificación de usuario actual, validación de tokens y reset de contraseña.
 * Gestiona cookies seguras para refresh tokens (httpOnly, sameSite, secure), genera
 * access tokens JWT, soporta autenticación OAuth con Google, y proporciona endpoints
 * para recuperación de contraseña con validación de schemas Zod.
 */
