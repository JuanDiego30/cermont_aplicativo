---
name: cermont.backend.backend-development
description: Build robust backend systems with modern technologies. Covers NestJS, PostgreSQL, Redis, REST APIs, authentication (OAuth 2.1, JWT), testing strategies, security best practices (OWASP Top 10), performance optimization, and DevOps practices.
triggers:
  - backend
  - API
  - REST
