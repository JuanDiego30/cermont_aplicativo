---
name: cermont.monorepo.monorepo-management
description: Master monorepo management with Turborepo and pnpm workspaces to build efficient, scalable multi-package repositories with optimized builds and dependency management. Use when setting up monorepos, optimizing builds, or managing shared dependencies.
triggers:
  - monorepo
  - pnpm workspace
  - turborepo
